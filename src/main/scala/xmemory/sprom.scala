...
object xpm_memory_sprom{
    def apply(
                 ...
                 USE_MEM_INIT: Int = 1, // DECIMAL
                 WAKEUP_TIME: String = "disable_sleep" // String
             )(dbiterra: Bool, douta: Bits, sbiterra: Bool, addra: Bits,  ena: Bool, injectdbiterra: Bool,
...
object sprom{
    def main(args: Array[String]): Unit = {
        SpinalConfig(targetDirectory = "verilog").generateVerilog(new sprom(64,2304,"distributed",0,"weight_conv2.mem"))
    }
}
